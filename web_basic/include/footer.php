        ...
        <div class="contents"> 
            <div class="addrWrap">
                ...
                <div style="display: flex; justify-content: center; align-items: center; gap: 30px; flex-wrap: wrap;">
                    <!-- <a href="https://www.nts.go.kr/" target="_blank"><img src="/web_basic/img/common/footer_partner_logo01.jpg" alt="국세청" style="height: 40px; width: auto;"></a> -->
                    <a href="https://www.mofa.go.kr" target="_blank"><img src="/web_basic/img/common/보건복지부.png" alt="외교부" style="height: 40px; width: auto;"></a>
                    <!-- <a href="https://www.moef.go.kr/" target="_blank"><img src="/web_basic/img/common/footer_partner_logo03.jpg" alt="개획재정부" style="height: 40px; width: auto;"></a> -->
                    <a href="https://www.koica.go.kr/" target="_blank"><img src="/web_basic/img/common/koica.png" alt="한국국제협력단" style="height: 30px; width: auto;"></a>
                    <a href="https://www.kofih.org/" target="_blank"><img src="/web_basic/img/common/kofi.png" alt="한국국제보건의료재단" style="height: 40px; width: auto;"></a>
